...
export default function RenterReviewsPage() {
    ...
    const fetchRenterReviews = useCallback(async () => {
        try {
            ...
            // Fetch reviews for this renter with detailed information
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-gray-400">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-xl font-bold text-black">
                            Reviews About You ({filteredReviews.length})
                        </h3>
                    </div>
                    ...
                    {filteredReviews.length > 0 ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-600 mb-4">
                                {filter === 'all'
                                    ? 'Reviews from hosts will appear here after completed trips.'
