...
import { AlertTriangle, Car, CheckCircle, Clock, User, X } from 'lucide-react';
...
export default function ManualBookingModal({
    ...
    const handleBookingSubmit = async () => {
        ...
        try {
            ...
            // Use the same RPC function as renter bookings for consistency
            const bookingPayload = {
                car_id: bookingDetails.vehicleId,
                renter_id: user.id, // Using host as renter for offline bookings
                host_id: user.id,
                ...
                booking_type: 'OFFLINE', // Mark as offline booking
            ...
            // Use the same business rules function as regular bookings
            ...
            console.log('📊 Manual booking result:', bookingResult);
            ...
            const { data: booking, error: fetchError } = await supabase
                .from('bookings')
                .select('*')
                .eq('id', firstResult.booking_id)
                .single();

            if (fetchError) {
                console.warn('Could not fetch created booking details:', fetchError);
            }
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 className="text-2xl font-bold text-black">Create Manual Booking</h2>
                    <button
                        onClick={onClose}
