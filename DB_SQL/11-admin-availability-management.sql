-- ============================================================================
-- ADMIN AVAILABILITY MANAGEMENT SYSTEM
-- ============================================================================
...
-- View 2: Problem vehicles that need admin attention
...
-- View 3: Revenue impact of availability blocks
...
-- Function to get detailed vehicle availability report
...
DO $$
BEGIN
  RAISE NOTICE 'Admin Availability Management System installed successfully!';
